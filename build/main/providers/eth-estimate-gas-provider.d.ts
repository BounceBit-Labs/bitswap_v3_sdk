...
export declare class EthEstimateGasSimulator extends Simulator {
    ...
    protected simulateTransaction(fromAddress: string, swapOptions: SwapOptions, swapRoute: SwapRoute, _l2GasData?: OptimismGasData | ArbitrumGasData | undefined, _providerConfig?: ProviderConfig | undefined): Promise<SwapRoute>;
}
