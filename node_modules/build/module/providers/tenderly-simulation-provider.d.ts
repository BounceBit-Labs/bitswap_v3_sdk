...
export declare class TenderlySimulator extends Simulator {
    ...
    simulateTransaction(fromAddress: string, swapOptions: SwapOptions, swapRoute: SwapRoute, _l2GasData?: ArbitrumGasData | OptimismGasData, providerConfig?: ProviderConfig): Promise<SwapRoute>;
